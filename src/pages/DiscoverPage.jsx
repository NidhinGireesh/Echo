        ...
        <div className="p-6 lg:p-12 relative w-full overflow-hidden max-w-7xl mx-auto">
            ...
            <section className="mb-16">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    <div>
                        <span className="text-violet-400 font-bold tracking-[0.2em] text-xs uppercase mb-3 block opacity-80">Curation Engine</span>
                        <h1 className="text-5xl lg:text-7xl font-black font-headline tracking-tighter leading-none text-on-surface">
                            Discover Your <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-500 to-fuchsia-500">Venture</span>
                        </h1>
                    </div>
                    <div className="flex gap-3">
                        <button className="glass-panel px-6 py-3 rounded-2xl flex items-center gap-2 text-sm font-semibold hover:bg-white/10 transition-all border border-white/5 backdrop-blur-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    <div className="md:col-span-2 lg:col-span-2 glass-panel p-8 relative overflow-hidden group border border-white/10 backdrop-blur-xl">
                        <div className="relative z-10 flex flex-col h-full">
                            <div className="flex justify-between items-start mb-12">
                                <span className="bg-violet-500/20 text-violet-300 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-violet-500/20">High Potential Match</span>
                                <button className="p-2 rounded-full bg-white/5 text-on-surface hover:text-violet-400 transition-colors">
                            ...
                            <div className="mt-auto">
                                <div className="flex flex-wrap gap-2 mb-6">
                                    {['React', 'Node.js', 'Tailwind'].map(tag => (
                                        <span key={tag} className="px-3 py-1 rounded-lg bg-white/5 text-[10px] text-violet-300 font-bold uppercase border border-white/10">{tag}</span>
                                    ))}
                                </div>
                                <button className="glass-button !w-full !py-4">Connect to Venture</button>
                            </div>
                        </div>
                    </div>

                    <div className="glass-panel p-6 flex flex-col border border-white/10 backdrop-blur-xl">
                        <div className="w-12 h-12 rounded-2xl bg-fuchsia-500/20 flex items-center justify-center text-fuchsia-400 mb-6 border border-fuchsia-500/20">
                        ...
                        <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                            ...
                            <span className="material-symbols-outlined text-violet-400 cursor-pointer hover:translate-x-1 transition-transform">arrow_forward</span>
                        </div>
                    </div>
                    ...
                    <div className="glass-panel overflow-hidden group border border-white/10 backdrop-blur-xl">
                        ...
                        <div className="p-6">
                            ...
                            <span className="inline-block px-3 py-1 rounded-lg bg-fuchsia-500/10 text-[10px] text-fuchsia-400 font-black uppercase tracking-widest">Security</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex gap-2">
                        <button className="p-2 rounded-full border border-white/10 text-on-surface-variant hover:bg-white/10"><span className="material-symbols-outlined">chevron_left</span></button>
                        <button className="p-2 rounded-full border border-white/10 text-on-surface-variant hover:bg-white/10"><span className="material-symbols-outlined">chevron_right</span></button>
                    </div>
                </div>
