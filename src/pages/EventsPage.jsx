    ...
    return (
        <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-12 relative z-10">
                ...
                <div className="relative h-[400px] md:h-[500px] rounded-[2.5rem] overflow-hidden group glass-panel">
                    ...
                    <div className="relative z-10 w-full h-full overflow-hidden">
                        ...
                        <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full max-w-2xl transform transition-transform duration-500 group-hover:translate-y-[-8px]">
                            ...
                            <h3 className="font-headline text-4xl md:text-5xl font-extrabold text-white mb-4 leading-tight drop-shadow-lg group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-br group-hover:from-primary group-hover:to-secondary transition-all duration-300">{events[0]?.title || 'Tathva 2026'}</h3>
            ...
            <section className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 h-auto">
                    ...
                    <div className="md:col-span-2 md:row-span-2 glass-panel p-6 flex flex-col group">
                        <div className="relative h-48 md:h-64 rounded-[1.5rem] overflow-hidden mb-6">
                            <img alt="Club Event" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" src={events[1]?.image || "/assets/drishti.png"} />
                        ...
                        <div className="space-y-4">
                            <h4 className="font-headline text-2xl font-black group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-br group-hover:from-primary group-hover:to-secondary transition-all duration-300">{events[1]?.title || 'Drishti 2026'}</h4>
                        ...
                        <div key={idx} className="md:col-span-2 glass-panel p-6 flex gap-6 group">
                            ...
                            <div className="flex flex-col justify-between py-1 flex-1">
                                <div>
                                    ...
                                    <h4 className="font-headline text-lg font-black group-hover:bg-clip-text group-hover:text-transparent group-hover:bg-gradient-to-br group-hover:from-primary group-hover:to-secondary transition-all duration-300">{event.title}</h4>
            ...
            <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                    { icon: 'sports_esports', label: 'Gaming', color: 'text-primary', bg: 'bg-primary/10', path: '/gaming' },
                    { icon: 'palette', label: 'Creative', color: 'text-secondary', bg: 'bg-secondary/10', path: '/creative' },
                    { icon: 'science', label: 'STEM', color: 'text-tertiary', bg: 'bg-tertiary/10', path: '/stem' },
                    { icon: 'fitness_center', label: 'Lifestyle', color: 'text-on-surface', bg: 'bg-white/10', path: '/lifestyle' },
                ].map((cat, i) => (
                    <Link key={i} to={cat.path} className="glass-panel p-6 flex flex-col items-center gap-3 hover:bg-white/5 transition-all group active:scale-95">
            ...
            <button className="fixed bottom-20 md:bottom-8 right-6 md:right-8 w-14 h-14 rounded-full bg-gradient-to-tr from-primary to-secondary text-[#070d1f] flex items-center justify-center hover:scale-110 hover:rotate-90 active:scale-90 transition-all z-[70]">
